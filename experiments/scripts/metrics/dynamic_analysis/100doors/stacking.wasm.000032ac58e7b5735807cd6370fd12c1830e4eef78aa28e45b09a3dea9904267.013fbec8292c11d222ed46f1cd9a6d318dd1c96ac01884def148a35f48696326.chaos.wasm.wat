(module
  ...
  (func $__fwritex (;16;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $fwrite (;17;) (type 5) (param i32 i32 i32 i32) (result i32)
  ...
  (func $strerror (;18;) (type 2) (param i32) (result i32)
    (local i32)
    block ;; label = @1
      i32.const 0
  ...
  (func $__lseek (;21;) (type 1) (param i32 i64 i32) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__stdio_seek (;22;) (type 1) (param i32 i64 i32) (result i64)
    local.get 0
    i32.load offset=56
    local.get 1
    local.get 2
  ...
  (func $fputs (;23;) (type 3) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    call $strlen
    local.set 2
  ...
  (func $vfprintf (;25;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 208
    i32.sub
  ...
  (func $printf_core (;26;) (type 9) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func $pop_arg (;27;) (type 10) (param i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
          block ;; label = @4
  ...
  (func $pad (;28;) (type 11) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 256
    i32.sub
  ...
  (func $long_double_not_supported (;29;) (type 7)
    i32.const 1107
    i32.const 3440
    call $fputs
    drop
  ...
  (func $__ofl_lock (;30;) (type 8) (result i32)
    i32.const 3724
  )
  (func $__stdio_exit (;31;) (type 7)
    (local i32 i32 i32)
    block ;; label = @1
      call $__ofl_lock
      i32.load
  ...
  (func $__towrite (;32;) (type 2) (param i32) (result i32)
    (local i32)
    local.get 0
    local.get 0
    i32.load offset=60
  ...
  (func $close (;33;) (type 2) (param i32) (result i32)
    block ;; label = @1
      local.get 0
  ...
  (func $__stdio_close (;34;) (type 2) (param i32) (result i32)
    local.get 0
    i32.load offset=56
    call $close
  )
  (func $__isatty (;35;) (type 2) (param i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $memset (;37;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $memcpy (;38;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $strnlen (;39;) (type 3) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    i32.const 0
    local.get 1
  ...
  (func $memchr (;40;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 2
    i32.const 0
    i32.ne
  ...
  (func $strlen (;41;) (type 2) (param i32) (result i32)
    (local i32 i32)
    local.get 0
    local.set 1
    block ;; label = @1
  ...
  (func $#func42<dummy> (@name "dummy") (;42;) (type 3) (param i32 i32) (result i32)
    local.get 0
  )
  (func $__lctrans (;43;) (type 3) (param i32 i32) (result i32)
    local.get 0
    local.get 0
    i32.or
    global.set 1
  ...
  (func $wctomb (;44;) (type 3) (param i32 i32) (result i32)
    block ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      i32.const 0
  ...
  (func $wcrtomb (;45;) (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block ;; label = @1
  ...
  (func $frexp (;46;) (type 12) (param f64 i32) (result f64)
    (local i64 i32)
    block ;; label = @1
      local.get 0
      i64.reinterpret_f64
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global $__stack_pointer (;0;) (mut i32) i32.const 70320)
